...
for(f in fs) {
        cmd = paste("/Users/Vitaly/sratoolkit/bin/fastq-dump --split-3", f) #convert the example data to FASTQ, use the fastq-dump command from the SRA Toolkit on each SRA file.
        cat(cmd,"\n") 
